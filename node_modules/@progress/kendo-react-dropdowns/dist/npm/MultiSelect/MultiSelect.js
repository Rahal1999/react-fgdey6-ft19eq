...
var MultiSelect = /** @class */ (function (_super) {
    ...
    MultiSelect.prototype.render = function () {
        ...
        return label
            ? (React.createElement(kendo_react_common_1.FloatingLabel, { label: label, value: text || utils_1.getItemValue(this.value[0], textField), style: { width: style ? style.width : undefined }, children: component, valid: isValid, id: this._inputId }))
            : component;
    };
    MultiSelect.prototype.renderSearchbar = function () {
        ...
        return (React.createElement(SearchBar_1.default, { id: this._inputId, size: Math.max((placeholderToShow || '').length, text.length, 1), tabIndex: this.props.tabIndex, accessKey: this.props.accessKey, placeholder: placeholderToShow, value: text, onChange: this.onChangeHandler, onKeyDown: this.onInputKeyDown, ref: this.searchbarRef, disabled: disabled, expanded: opened, owns: this.base.listBoxId, activedescendant: ariaActivedescendant, describedby: 'tagslist-' + this.base.guid, clearButton: clearButton, clearButtonClick: this.clearButtonClick }));
    };
    ...
    MultiSelect.prototype.getFocusedState = function () {
        ...
        var text = this.props.filter !== undefined ? this.props.filter : this.state.text;
        var _a = this.props, allowCustom = _a.allowCustom, _b = _a.data, data = _b === void 0 ? [] : _b, dataItemKey = _a.dataItemKey, virtual = _a.virtual, textField = _a.textField;
        var skip = (virtual && virtual.skip) || 0;
        var focusedInd;
        ...
        if (allowCustom && text) {
            ...
            focusedInd = utils_1.itemIndexStartsWith(data, text, textField);
            return {
