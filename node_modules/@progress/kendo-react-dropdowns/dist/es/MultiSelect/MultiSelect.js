...
var MultiSelect = /** @class */ (function (_super) {
    ...
    MultiSelect.prototype.render = function () {
        ...
        return label
            ? (React.createElement(FloatingLabel, { label: label, value: text || getItemValue(this.value[0], textField), style: { width: style ? style.width : undefined }, children: component, valid: isValid, id: this._inputId }))
            : component;
    };
    MultiSelect.prototype.renderSearchbar = function () {
        ...
        return (React.createElement(SearchBar, { id: this._inputId, size: Math.max((placeholderToShow || '').length, text.length, 1), tabIndex: this.props.tabIndex, accessKey: this.props.accessKey, placeholder: placeholderToShow, value: text, onChange: this.onChangeHandler, onKeyDown: this.onInputKeyDown, ref: this.searchbarRef, disabled: disabled, expanded: opened, owns: this.base.listBoxId, activedescendant: ariaActivedescendant, describedby: 'tagslist-' + this.base.guid, clearButton: clearButton, clearButtonClick: this.clearButtonClick }));
    };
    ...
    MultiSelect.prototype.getFocusedState = function () {
        ...
        if (allowCustom && text) {
            ...
            focusedInd = itemIndexStartsWith(data, text, textField);
            return {
